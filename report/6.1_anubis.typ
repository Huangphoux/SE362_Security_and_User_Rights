...
Anubis khác Turnstile ở việc không cần phải thu thập thông tin người dùng để phân biệt được, mà ngầm định việc trình duyệt của người dùng sẽ đủ hiện đại để có thể sử dụng thuật toán SHA-256.
...
Việc băm thuật toán SHA-256 yêu cầu trình duyệt phải sử dụng được JavaScript. Đến giữa năm 2025, Anubis đã thêm một bài kiểm tra khác mà không cần sử dụng JavaScript bằng cách tận dụng tính năng Meta refresh của HTML, yêu cầu trình duyệt tự động tải lại trang sau một khoảng thời gian định trước.
